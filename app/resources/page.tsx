...
export default function ResourcesPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[400px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center w-full">
          ...
          <div className="max-w-4xl mx-auto flex gap-4">
            ...
            <Button className="bg-gold hover:bg-gold-light text-navy-dark px-8 py-4 text-lg font-semibold">
              OFFER A RESOURCE
            </Button>
            <Button className="bg-navy-dark hover:bg-navy-medium text-white px-8 py-4 text-lg font-semibold">
              REQUEST A RESOURCE
            </Button>
          </div>
        </div>
      ...
      {/* Category Filters */}
      <section className="bg-navy-dark text-white py-6">
          ...
          <div className="flex items-center gap-6 overflow-x-auto">
            {categories.map((category, idx) => {
              ...
              return (
                <button
                  key={idx}
                  className={`flex items-center gap-2 px-6 py-3 rounded-lg whitespace-nowrap font-semibold transition-colors ${
                    category.active
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <Card className="bg-gold text-navy-dark overflow-hidden">
              <CardContent className="p-12">
                ...
                <h3 className="text-3xl font-bold mb-4">Have Something to Offer?</h3>
                <p className="text-navy-medium mb-6 text-lg">
